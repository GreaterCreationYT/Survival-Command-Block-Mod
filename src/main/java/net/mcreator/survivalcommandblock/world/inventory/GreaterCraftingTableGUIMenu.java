...
package net.mcreator.survivalcommandblock.world.inventory;
...
public class GreaterCraftingTableGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GreaterCraftingTableGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SurvivalCommandBlockModMenus.GREATER_CRAFTING_TABLE_GUI.get(), id);
		...
		this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 61, 53) {
		}));
		this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 79, 53) {
		}));
